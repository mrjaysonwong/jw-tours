...
export const NewsletterTemplate = ({ tips = [] }) => (
  <Html>
    <Head />
    <Body style={main}>
      ...
      <Container style={container}>
        <Section style={logo}>
          <Img
            width={146}
            src={`https://react-email-demo-7csr9hg71-resend.vercel.app/static/stack-overflow-logo.png`}
          />
        </Section>
          ...
          <Row>
            ...
            <Column style={headerImageContainer}>
              <Img
                style={headerImage}
                width={340}
                src={`https://react-email-demo-7csr9hg71-resend.vercel.app/static/stack-overflow-header.png`}
              />
            </Column>
          </Row>
        </Section>
      ...
      <Section style={footer}>
        ...
        <Img
          width={111}
          src={`https://react-email-demo-7csr9hg71-resend.vercel.app/static/stack-overflow-logo-sm.png`}
        />
...
const headerImageContainer = { padding: '30px 10px' };

const headerImage = { maxWidth: '100%' };
const title = {
  margin: '0 0 15px',
  fontWeight: 'bold',
  fontSize: '21px',
...
const logo = { display: 'flex', background: '#f3f3f5', padding: '20px 30px' };
const header = {
...
const footerDivider = { ...divider, borderColor: '#d6d8db' };
