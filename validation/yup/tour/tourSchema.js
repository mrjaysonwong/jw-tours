...
//           .test(
//             'is-valid-image',
//             'Invalid image format. Only JPEG and PNG images (URL or base64) are allowed.',
//             (value) => {
//               if (value?.startsWith('http')) return true;
//               return /^data:image\/(jpeg|png);base64,[A-Za-z0-9+/=]+$/.test(
//                 value
//               );
//             }
//           ),
...
//     }),
//   }),
//   freeCancellation: yup.object().shape({
//     isFreeCancellation: yup.boolean().notRequired(),
//   }),
