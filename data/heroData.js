...
export const slides = [
  ...
  },
  {
    ...
    label: 'Nature',
    subHeader:
      'Immerse yourself in the breathtaking natural wonders and scenic landscapes of our destinations.',
  ...
  },
  {
    ...
    subHeader:
      'Discover the pristine beauty of secluded islands and turquoise waters on our exciting island hopping tours.',
  ...
  },
  {
    ...
    label: 'Food',
    subHeader:
      'Savor the diverse flavors and traditional dishes from our curated culinary experiences and local food tours.',
  ...
  },
  {
    ...
    label: 'Culture',
    subHeader:
      'Immerse yourself in vibrant cultural festivals and traditions that showcase the unique heritage of each region.',
