      ...
      <StyledCard sx={{ width: 'clamp(300px, 50%, 300px)' }}>
        {confirmation ? (
          <>
            ...
            >
              We have emailed you the account verification link. If you have not
              received an email from us, you can{' '}
          ...
          <>
            <Box sx={{ mb: 2 }}>
              <Typography variant="h6">Account Verification Link</Typography>

              <Typography color="gray">
                Enter your email address below to resend your account
                verification link.
              </Typography>
            </Box>
